...
export const ViewCollectedSpermSamples = () => {
  let user=useSelector(selectUser);
  user=user.user;
  const accessToThisPage = user.permissions.spermSampleManagement.includes("view collected sperm samples");
...
export default ViewCollectedSpermSamples;
