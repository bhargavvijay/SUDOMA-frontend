...
export const ViewRecruitedSurrogates = () => {
  let user=useSelector(selectUser);  user=user.user;  const accessToThisPage=user.permissions.surrogateManagement.includes("view recruited surrogates"
);
...
export default ViewRecruitedSurrogates;
