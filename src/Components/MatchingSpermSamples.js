...
import VarianceFilter from "./VarianceFillter";

const MatchingSpermSamples = ({ setShowMatchesPage, data, reqId, handleFindMatches , selectedRequisition ,heightVariance, weightVariance, setHeightVariance, setWeightVariance}) => {
